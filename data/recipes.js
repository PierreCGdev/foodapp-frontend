export const recipes = [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "A classic, easy dish, equally comforting on a warm summer day or a rainy winter night.",
    level: "easy",
    time: "20 min",
    rating: 3.2,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "Made with fresh figs, creamy avocado, toasted walnuts, and homemade balsamic vinaigrette for a delicious fall salad that will fill you up",
    level: "easy",
    time: "15 min",
    rating: 5,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "With a few simple steps you can create a basic club sandwich, add a few extra layers or toppings and you can dress this sandwich up as much as you’d like!",
    level: "easy",
    time: "15 min",
    rating: 4.9,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "This traditional favorite includes warm rice, richly savorous vegetables and perfectly marinated beef. Perfect for winter!",
    level: "difficult",
    time: "45 min",
    rating: 3.8,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "This dish has a blend of flavors and textures that will surely please anyone's palate and it's a meal on its own.",
    time: "30 min",
    rating: 3.5,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "These Japanese pan-fried dumplings, or Gyoza, are a popular weeknight meal as well as a great appetizer for your next dinner party.",
    level: "intermediate",
    time: "1 hour",
    rating: 3.8,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "This adaptable dish is easy to change to reflect the flavors of every season.",
    level: "intermediate",
    time: "45 min",
    rating: 4.3,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "A simple, no-fail recipe using ingredients you already have on hand!",
    level: "easy",
    time: "15 min",
    rating: 3.8,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "Learn the trick of making home-made sushi for a cheaper, more fun alternative to the upscale kind!",
    level: "intermediate",
    time: "45 min",
    rating: 3.9,
    ingredients: [
  ...
  },
  {
    ...
    servingNb: 1,
    longDesc:
      "This classic, Greek-style salad is the brightest example of taking simple ingredients and transforming them into a finger-licking dish.",
    level: "easy",
    time: "25 min",
    rating: 5,
    ingredients: [
